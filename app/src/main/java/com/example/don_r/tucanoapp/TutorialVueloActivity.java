...
public class TutorialVueloActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_vuelo);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){//cuando se presione cerrar sesion debe ir a login activity
            case R.id.mCerrar:
                ...
                editor.commit();
                Intent intentL= new Intent(TutorialVueloActivity.this, LoginActivity.class);
                startActivity(intentL);
                finish();
                break;
            case R.id.mPerfil: //cuando se presione perfil debe ir a perfil activity
                Intent intentP= new Intent(TutorialVueloActivity.this, PerfilActivity.class);
                intentP.putExtra("username", username);
                intentP.putExtra("correo", correo);
                startActivity(intentP);
                break;
            case R.id.mMainActivity:
                Intent intentM = new Intent(TutorialVueloActivity.this,MainActivity.class);
